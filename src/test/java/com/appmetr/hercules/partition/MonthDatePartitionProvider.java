...
import com.appmetr.hercules.partition.dated.DatePartitionProvider;
...
public class MonthDatePartitionProvider<T extends DatedColumn> extends DatePartitionProvider<T> {
